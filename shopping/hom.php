...
<div id="mainblock">
  <div id="innerblock">
    <div id="toppanel">
	  ...
	  <a href="hom.php" class="menu1">Home Page</a> <img src="images/tp_divider.gif" width="2" height="59" alt="" class="tp_divider" /> <a href="vewproduct.php?a=men" class="menu2">Men's <br>Fashion</a> <img src="images/tp_divider.gif" width="2" height="59" alt="" class="tp_divider" /> <a href="womenf.php?a=women" class="menu2">Women's <br>Fashion</a> <img src="images/tp_divider.gif" width="2" height="59" alt="" class="tp_divider" /> <a href="kids.php?a=kids" class="menu2">Kids</a> <img src="images/tp_divider.gif" width="2" height="59" alt="" class="tp_divider" /> <a href="bags.php?a=bags" class="menu2">Bags</a> <img src="images/tp_divider.gif" width="2" height="59" alt="" class="tp_divider" /> <a href="contact.php" class="menu2">Contact <br>us</a> <img src="images/tp_divider.gif" width="2" height="59" alt="" class="tp_divider" /> <a href="signup.php" class="menu2">Register Now</a> <img src="images/tp_divider.gif" width="2" height="59" alt="" class="tp_divider" /> <a href="login.php" class="menu2">LogIn</a> </div>
    ...
    <div class="contentblock">
      <div class="contentpanel">
        ...
        <div style="float:left; padding-bottom:55px;"> <img src="images/suit.jpg" width="161" height="120" alt="" class="cnt_image1" /> <img src="images/sh.jpg" width="160" height="119" alt="" class="cnt_image1" /> <img src="images/wes.jpg" width="162" height="119" alt="" class="cnt_image1" /> </div>
        ...
        <a href="#"><img src="images/cnt_readmore.gif" width="88" height="26" alt="" class="cnt_readmore" /></a>
        <div class="cnt_headingblock"> <img" width="13" height="13" alt="" class="cnt_btn1" /> <img src="images/cnt_heading4.jpg" width="175" height="30" alt="" class="cnt_heading" /> </div>
