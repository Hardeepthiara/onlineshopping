  ...
  <div id="innerblock">
    ...
    <div class="contentblock">
      <div class="contentpanel">
        ...
        <div style="float:left; width:670px;"> <div class="h"><h3>Log In</h3>
		<form method="post" action="">
		Email:&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="email"><br><br>
		Password:<input type="password" name="password"><br><br>
		<input type="submit" name="submit" value="Login"><a href="signup.php"><input type="button" name="sub" value="SignUp"></a>
		<a href="change.php"><input type="button" name="sub" value="Change Password"></a></form></div>
        </div>
		...
		if(isset($_REQUEST['submit']))
		{
			...
			session_start();
			$_SESSION['el']=$em;
			echo"<p style='color:white;text-align:center'>session is set</p>";
			$ab=mysqli_query($con,"select * from signup where email='$em' and password='$pass'");
			if(mysqli_num_rows($ab)>0)
			{
				
				echo"<script>alert('success')</script>";
				while($q=mysqli_fetch_array($ab))
				{
				$role=$q['role'];
				}
				if($role=="admin")
