  ...
  <div id="innerblock">
    ...
    <div class="contentblock">
      <div class="contentpanel">
        ...
        <div style="float:left; width:670px;"> <div class="h"><h3>Sign Up</h3>
...
Area Code:<input type="text" name="area"><br>
...
<input type="submit" name="sub" value="Submit"> 
		...
		if(isset($_REQUEST['sub']))
		{
			...
			$mn=mysqli_query($con,"insert into signup values('$a','$b','$c','$d','$e','$f','$g','$h')");
			if($mn)
			{
